...
const getPostMessageFromPage = (pageId, accessToken, postId) => __awaiter(void 0, void 0, void 0, function* () {
...
const fetchMessagesFromPages = (accessTokenPage1, accessTokenPage2, postId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const page of pages) {
        const message = yield getPostMessageFromPage(page.pageId, page.accessToken, postId);
        if (message) {
