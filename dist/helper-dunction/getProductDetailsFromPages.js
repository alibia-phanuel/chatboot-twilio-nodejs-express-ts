...
async function getProductIdFromPages(productId) {
    ...
    const fetchProductId = async (productId, accessToken) => {
        try {
            const response = await axios_1.default.get(url(productId, accessToken));
